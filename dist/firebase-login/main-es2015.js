...
LoginComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: LoginComponent, selectors: [["login"]], decls: 11, vars: 0, consts: [[3, "ngSubmit"], ["loginForm", "ngForm"], ["type", "email", "id", "email", "name", "email", "placeholder", "Email", "ngModel", ""], ["type", "password", "id", "password", "name", "password", "placeholder", "Has\u0142o", "ngModel", ""], ["type", "submit"]], template: function LoginComponent_Template(rf, ctx) { if (rf & 1) {
...
function UsersEditComponent_div_16_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngSubmit", function UsersEditComponent_div_16_Template_form_ngSubmit_1_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r6); const _r4 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](2); const ctx_r5 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r5.onSubmit(_r4); });
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function UsersEditComponent_div_16_Template_button_click_21_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r6); const ctx_r7 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r7.onClose(); });
...
class UsersEditComponent {
    ...
    onSubmit(form) {
        const newUser = new _models_user_model__WEBPACK_IMPORTED_MODULE_1__["User"]({ firstname: form.value.firstname, lastname: form.value.lastname, adress: form.value.adress, phone: form.value.phone, id: Math.random() });
    }
    onClose() {
...
UsersEditComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: UsersEditComponent, selectors: [["app-users-edit"]], decls: 17, vars: 2, consts: [[3, "click"], [1, "table"], [1, "tableBody"], [1, "tableRow"], [1, "tableCell"], ["class", "tableRow", 4, "ngFor", "ngForOf"], [4, "ngIf"], [3, "ngSubmit"], ["userEditForm", "ngForm"], ["for", "firstname"], ["type", "text", "name", "firstname", "id", "firstname", "ngModel", ""], ["for", "lastname"], ["type", "text", "name", "lastname", "id", "lastname", "ngModel", ""], ["for", "adress"], ["type", "text", "name", "adress", "id", "adress", "ngModel", ""], ["for", "phone"], ["type", "text", "name", "phone", "id", "phone", "ngModel", ""], ["type", "submit"]], template: function UsersEditComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "button", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function UsersEditComponent_Template_button_click_1_listener() { return ctx.onClose(); });
...
class UserService {
    ...
    fetchUsers() {
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["of"])([
            new src_app_models_user_model__WEBPACK_IMPORTED_MODULE_2__["User"]({ firstname: 'Jan', lastname: 'Kowalski', adress: 'Warszawa, miastowa 12a', phone: '+48754789345', id: '1' }),
            new src_app_models_user_model__WEBPACK_IMPORTED_MODULE_2__["User"]({ firstname: 'Magdalena', lastname: 'Nowak', adress: 'Poznań, miastowa 14', phone: '+48458542905', id: '2' }),
            new src_app_models_user_model__WEBPACK_IMPORTED_MODULE_2__["User"]({ firstname: 'Jan', lastname: 'Nowak', adress: 'Poznań, miastowa 14', phone: '+48485735274', id: '3' }),
            new src_app_models_user_model__WEBPACK_IMPORTED_MODULE_2__["User"]({ firstname: 'Adam', lastname: 'Kołodziej', adress: 'Warszawa, targowa 5', phone: '+48456439563', id: '4' }),
        ]);
    }
    addUser() {
    }
