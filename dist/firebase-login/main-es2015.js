...
AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({ factory: function AppModule_Factory(t) { return new (t || AppModule)(); }, providers: [_pages_login_login_component__WEBPACK_IMPORTED_MODULE_4__["LoginComponent"]], imports: [[
...
LoginComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: LoginComponent, selectors: [["login"]], decls: 18, vars: 4, consts: [[1, "login-container"], [1, "form-container"], [1, "form-header"], [1, "form", 3, "ngSubmit"], ["loginForm", "ngForm"], [1, "form-element"], ["type", "email", "id", "email", "name", "email", "ngModel", "", 1, "email-input"], ["for", "email", 1, "email-label"], ["type", "password", "id", "password", "name", "password", "ngModel", "", 1, "password-input"], ["for", "password", 1, "password-label"], [1, "wrong-auth-text", 3, "ngStyle"], ["type", "submit", 1, "login-button"]], template: function LoginComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngSubmit", function LoginComponent_Template_form_ngSubmit_4_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r1); const _r0 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](5); return ctx.onSubmit(_r0); });
...
UsersEditComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: UsersEditComponent, selectors: [["app-users-edit"]], viewQuery: function UsersEditComponent_Query(rf, ctx) { if (rf & 1) {
    ...
    } }, decls: 51, vars: 1, consts: [["type", "button", 1, "logout-button", 3, "click"], [1, "table-container"], [1, "add_user-button", 3, "click"], [1, "table"], [1, "tableBody"], [1, "tableHead"], [1, "tableRow", "tableRow--odd"], [1, "tableCell--head"], [3, "ngClass", 4, "ngFor", "ngForOf"], ["onclick", "event.stopPropagation()", 1, "add_user-container"], [3, "ngSubmit"], ["userEditForm", "ngForm"], ["for", "firstname", 1, "add_user-label"], ["type", "text", "name", "firstname", "id", "firstname", "ngModel", "", 1, "add_user-input"], ["for", "lastname", 1, "add_user-label"], ["type", "text", "name", "lastname", "id", "lastname", "ngModel", "", 1, "add_user-input"], ["for", "adress", 1, "add_user-label"], ["type", "text", "name", "adress", "id", "adress", "ngModel", "", 1, "add_user-input"], ["for", "phone", 1, "add_user-label"], ["type", "text", "name", "phone", "id", "phone", "ngModel", "", 1, "add_user-input"], ["type", "submit", 1, "add_user-button--add", 3, "click"], ["type", "button", 1, "add_user-button--clear", 3, "click"], ["type", "button", 1, "add_user-button--close", 3, "click"], [3, "ngClass"], [1, "tableCell"], [1, "tableCell__text"], [1, "delete-button", 3, "click"]], template: function UsersEditComponent_Template(rf, ctx) { if (rf & 1) {
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _firebase_auth__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @firebase/auth */ "./node_modules/@firebase/auth/dist/auth.js");
/* harmony import */ var _firebase_auth__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_firebase_auth__WEBPACK_IMPORTED_MODULE_2__);
...
class AuthService {
    ...
    onLogin(email, password) {
        const result = new rxjs__WEBPACK_IMPORTED_MODULE_4__["Observable"]((observer) => {
    ...
    onLogout() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            try {
                yield firebase_app__WEBPACK_IMPORTED_MODULE_3__["auth"]().signOut();
...
AuthService.ɵfac = function AuthService_Factory(t) { return new (t || AuthService)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"](_angular_router__WEBPACK_IMPORTED_MODULE_5__["Router"])); };
...
module.exports = __webpack_require__(/*! C:\work\projects\firebase-login\src\main.ts */"./src/main.ts");
